...
const CardPage = () => {
    ...
    useEffect(() => {
        fetchProducts('/api/products/category/card'); // Chiamata API per ottenere i prodotti
    ...
    return (
        <div>
            ...
            <div className="card-banner">
                <h1
                    className="titlepage"
                    onClick={scrollToProducts} // Al clic, esegui lo scroll alla sezione dei prodotti
...
// Esporta il componente CardPage
